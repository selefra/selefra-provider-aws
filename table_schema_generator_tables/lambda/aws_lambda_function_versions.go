...
func (x *TableAwsLambdaFunctionVersionsGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("memory_size").ColumnType(schema.ColumnTypeBigInt).Build(),
		...
		table_schema_generator.NewColumnBuilder().ColumnName("code_size").ColumnType(schema.ColumnTypeBigInt).Build(),
